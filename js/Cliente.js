    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            for (i = 0; i < json.items.length; i++) {
                ...
                $("#resultado").append("<td>" + "&nbsp;&nbsp;&nbsp;&nbsp;" + json.items[i].email + "&nbsp;&nbsp;&nbsp;&nbsp;" + "</td>");
                $("#resultado").append("<td>" + "&nbsp;&nbsp;&nbsp;&nbsp;" + json.items[i].age + "&nbsp;&nbsp;&nbsp;&nbsp;" + "</td>");
...
function buscarPorID(id) {
    $.ajax({
        url: 'https://g1a8cffe5c1de69-db202109231547.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + id.val(),
        dataType: 'json',
        type: 'GET',
        success: function(json) {
            $("#resultado").empty();
            ...
            $("#resultado").append("<td>" + "&nbsp;&nbsp;&nbsp;&nbsp;" + json.items[0].name + "&nbsp;&nbsp;&nbsp;&nbsp;" + "</td>");
            $("#resultado").append("<td>" + "&nbsp;&nbsp;&nbsp;&nbsp;" + json.items[0].email + "&nbsp;&nbsp;&nbsp;&nbsp;" + "</td>");
            $("#resultado").append("<td>" + "&nbsp;&nbsp;&nbsp;&nbsp;" + json.items[0].age + "&nbsp;&nbsp;&nbsp;&nbsp;" + "</td>");
            $("#resultado").append("</tr>");
