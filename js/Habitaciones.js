function consultar() {
    ...
    $.ajax({
        url: 'https://g1a8cffe5c1de69-db202109231547.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/room/room',
        type: 'GET',
        dataType: 'JSON',
...
function buscarPorID(id) {
    $.ajax({
        url: 'https://g1a8cffe5c1de69-db202109231547.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/room/room/' + id.val(),
        dataType: 'json',
        type: 'GET',
        success: function(json) {
            $("#resultado").empty();
